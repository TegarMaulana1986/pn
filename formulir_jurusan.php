...
<form action="code/proses/input/input_jurusan.php" method="POST">
    ...
    <tr>
        <td><b>Tingkatan Sabuk</b></td>
    </tr>
    <tr>
        <td><input type="text" name="nama_jurusan" size="25px" maxlength="20" placeholder="ketikkan Tingkatan Sabuk.." required>&nbsp;&nbsp;&nbsp; <input class="button" type="submit" value="Simpan"></td>
    </tr>
