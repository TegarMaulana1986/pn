	...
	<table width="100%">
		<tr>
			<td>
				...
				<?php } ?>
				<a href="code/pdf/pdf_mapel.php" target="_blank"><input class="button" type="button" value="Print"></a>
			</td>
...
<table id="daftar-table" border='0' bordercolor="black" cellpading='2' cellspacing='2' width='100%'>
	<tr align='center'>
		<th class="normal">Kode Materi</th>
		<th class="normal">Nama Materi</th>
		<?php
		if ($_SESSION['type_user'] == "Admin") {
		?>
