                        ...
                        <td>
                            <select name="kelas_sk">
                                <?php if ($isi['kelas_sk'] == "X") { ?>
                                    ...
                                    <option value="X" selected>I-II</option>
                                    <option value="XI">III-IV</option>
                                    <option value="XII">V-VI</option>
                                <?php
                                } else if ($isi['kelas_sk'] == "XI") { ?>
                                    <option value="" disabled>Pilih Kelas</option>
                                    <option value="X">I-II</option>
                                    <option value="XI" selected>III-IV</option>
                                    <option value="XII">V-VI</option>
                                <?php
                                } else if ($isi['kelas_sk'] == "XII") { ?>
                                    <option value="" disabled>Pilih Kelas</option>
                                    <option value="X">I-II</option>
                                    <option value="XI">III-IV</option>
                                    <option value="XII" selected>V-VI</option>
                            </select>&nbsp;&nbsp;
                        <?php
